...
import (
	...
	"github.com/ahlusar1989/swagger-ui/timeofday"
)
...
func configureAPI(api *operations.TimeofdayAPI) http.Handler {
	...
	api.TimeGetHandler = operations.TimeGetHandlerFunc(timeofday.GetClock)

	api.TimePostHandler = operations.TimePostHandlerFunc(timeofday.PostClock)
